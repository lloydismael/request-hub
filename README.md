...
[![Latest Tag](https://img.shields.io/badge/Latest-v50.9-0ea5e9)](https://hub.docker.com/r/lloydismael12/request-hub/tags)
...
- **Current image tag:** `lloydismael12/request-hub:v50.9`
- **App version shown in profile:** `v50.9`
...
```powershell
docker run --rm -p 127.0.0.1:8000:8000 --env-file .env lloydismael12/request-hub:v50.9
```
...
docker build --pull --no-cache --build-arg APP_VERSION=v50.9 -t lloydismael12/request-hub:v50.9 .
docker run --rm -p 127.0.0.1:8000:8000 --env-file .env -e APP_VERSION=v50.9 lloydismael12/request-hub:v50.9
```

### Push to Docker Hub

```powershell
docker push lloydismael12/request-hub:v50.9
# Do not retag or push latest until CVE scans on v50.9 are clean.
```
...
**Key steps:**
1. Push image to Docker Hub (`lloydismael12/request-hub:v50.9` or your next release tag). Do not retag `latest` until scans are clean.
