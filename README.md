...
[![Latest Tag](https://img.shields.io/badge/Latest-v48.8-0ea5e9)](https://hub.docker.com/r/lloydismael12/request-hub/tags)
...
- **Current image tag:** `lloydismael12/request-hub:v48.8`
- **App version shown in profile:** `v48.8`
- **Latest update included:**
      - Matched ESG Performance Tracker Excel export columns and row values to the tracker table.
