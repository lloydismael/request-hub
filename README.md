...
[![Latest Tag](https://img.shields.io/badge/Latest-v48.9-0ea5e9)](https://hub.docker.com/r/lloydismael12/request-hub/tags)
...
- **Current image tag:** `lloydismael12/request-hub:v48.9`
- **App version shown in profile:** `v48.9`
- **Latest update included:**
      - Matched ESG Performance Tracker cell and row sizing to the SQR Tracker while freezing only Account Name and Service Description.
